...
namespace WebApp.Models
{
    ...
    {
        public const string ApplicationCookie = "AdCustomAuthCookie";
    }

    /// <summary>
    /// Active Directory authentication service -reserved for hybrid authentication.
    /// </summary>
    public class AdAuthenticationService
    {
        ...
        private ClaimsIdentity CreateIdentity(UserPrincipal userPrincipal)
        {
            ...
            // TODO: Add custom application claims if you need to add more information stored on the cookie
            return identity;
        }
    }
}